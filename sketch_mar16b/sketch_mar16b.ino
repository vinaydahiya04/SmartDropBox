...
const char* ssid     = "Rhythm’s iPhone";   //your network SSID
const char* password = "ansutfuck";   //your network password
 
String myScript = "/macros/s/AKfycbzVElGieJGCb7WicAdoK6rQkPw1k0EW-KRZiv6qgUTSoOiBWaBNPQy1zd3LwLnyJCUe/exec";    //Create your Google Apps Script and replace the "myScript" path.
